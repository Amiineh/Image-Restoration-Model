...
if __name__ == '__main__':
    ...
    image_restoration_model.load_state_dict(model_state_dict)
    ...
    with torch.inference_mode():
        for corrupted_img_path in tqdm.tqdm(corrupted_img_paths):
            ...
            # print("Raw predicted image min, max:", predicted_img.min(), predicted_img.max())
            # print("Raw predicted mask min, max:", predicted_mask.min(), predicted_mask.max())
            # print("Predicted mask value range:", predicted_mask.min(), predicted_mask.max())
